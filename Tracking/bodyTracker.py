...
# Replace "inputVideo.mp4" with the path to your input video file
video_path = "Emotes.mp4"
cap = cv2.VideoCapture(video_path)

# Define VideoWriter to save the output video
fourcc = cv2.VideoWriter_fourcc(*'mp4v')  # Codec for MP4 files
output_filename = "emotesTracking.mp4"
...
with mp_pose.Pose(
    ...
    while cap.isOpened():
        ...
        cv2.imshow('Body Tracking - Video', image)
